    ...
    <>
      ...
      >
        ...
        <div className="nav-group" onClick={e => e.stopPropagation()}>
          ...
          {/* Reports */}
          <NavLink className={navItemClass} to="/report" onClick={close}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Eagle View */}
          <NavLink className={navItemClass} to="/eagle-view" onClick={close}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="nav-logout-footer" onClick={e => e.stopPropagation()}>
